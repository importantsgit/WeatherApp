...
class PlaceMark: Identifiable, ObservableObject {
    ...
    init(title: String, phoneNumber: String?, address: String?, description: String?, tag: String?) {
        id = UUID()
        self.title = title
